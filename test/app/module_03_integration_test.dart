...
void main() {
  testWidgets(
    'Module 3 hub, lesson, and calculator navigation create no incident',
    (tester) async {
      ...
      await monitor.startSession(
        AssessmentSession(
          id: 'module-3-active-session',
          studentName: 'Student',
          assessmentName: 'Seat Work 2',
          startedAt: now,
      ...
      expect(find.text('Aviation Mathematics'), findsOneWidget);
      final hubScrollable = find
          ...
          .first;
      final module3Card = find.byKey(const ValueKey('open-module-03'));
      await tester.scrollUntilVisible(
        module3Card,
        300,
        scrollable: hubScrollable,
      );
      await tester.tap(module3Card);
      await tester.pumpAndSettle();
      ...
      final moduleScrollable = find
          ...
          .first;
      final firstLesson = find.byKey(const ValueKey('module3-lesson-m03_l01'));
      await tester.scrollUntilVisible(
        firstLesson,
        450,
      ...
      final calculatorLauncher = find.byKey(
        const ValueKey('module3-open-calculator'),
      );
      await tester.scrollUntilVisible(
        calculatorLauncher,
        -500,
      ...
      expect(
        await repository.loadIncidents('module-3-active-session'),
        isEmpty,
      );
    },
  );
