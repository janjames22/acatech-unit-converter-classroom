...
void main() {
  testWidgets(
    'Module 4 hub, lesson, and calculator navigation create zero incidents',
    (tester) async {
      ...
      final session = AssessmentSession(
        id: 'module-4-active-session',
        studentName: 'Student',
        assessmentName: 'Seat Work 3 preparation',
      ...
      final hubScrollable = find
          ...
          .first;
      final module4Card = find.byKey(const ValueKey('open-module-04'));
      await tester.scrollUntilVisible(
        module4Card,
        400,
        scrollable: hubScrollable,
      );
      await tester.tap(module4Card);
      await tester.pumpAndSettle();
      ...
      final moduleScrollable = find
          ...
          .first;
      final firstLesson = find.byKey(const ValueKey('module4-lesson-m04_l01'));
      await tester.scrollUntilVisible(
        firstLesson,
        450,
      ...
      final calculatorLauncher = find.byKey(
        const ValueKey('module4-open-calculator'),
      );
      await tester.scrollUntilVisible(
        calculatorLauncher,
        -500,
