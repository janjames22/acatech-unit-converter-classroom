...
class FractionProgressTracker extends StatelessWidget {
  const FractionProgressTracker({
  ...
  final Module3Progress progress;
  ...
  Widget build(BuildContext context) {
    ...
    final statusLabel = switch (status) {
      Module3CompletionStatus.notStarted => 'Not started',
      Module3CompletionStatus.inProgress => 'In progress',
      Module3CompletionStatus.complete => 'Complete',
    };
    return Card(
      key: const ValueKey('module3-progress'),
      child: Padding(
