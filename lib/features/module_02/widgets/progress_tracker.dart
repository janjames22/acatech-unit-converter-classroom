...
class ProgressTracker extends StatelessWidget {
  ...
  final Module2Progress progress;
  ...
  Widget build(BuildContext context) {
    ...
    final statusLabel = switch (status) {
      Module2CompletionStatus.notStarted => 'Not started',
      Module2CompletionStatus.inProgress => 'In progress',
      Module2CompletionStatus.complete => 'Complete',
    };
    return Card(
      key: const ValueKey('module2-progress'),
      child: Padding(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                Text('${progress.score}/$questionCount practice score'),
              ],
            ),
