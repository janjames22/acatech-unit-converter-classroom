...
class MixedProgressTracker extends StatelessWidget {
  const MixedProgressTracker({
  ...
  final Module4Progress progress;
  ...
  Widget build(BuildContext context) {
    ...
    final statusLabel = switch (status) {
      Module4CompletionStatus.notStarted => 'Not started',
      Module4CompletionStatus.inProgress => 'In progress',
      Module4CompletionStatus.complete => 'Complete',
    };
    return Card(
      key: const ValueKey('module4-progress'),
      child: Padding(
